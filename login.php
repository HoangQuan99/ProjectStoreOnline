    ...
    <div class="content">
    	 <div class="login_panel">
        	...
        	<p>Mời nhập thông tin</p>
        	 <!-- <?php
			 	if(isset($_POST['email'])==true && empty($_POST['email'])==false)
			 	{
			 		...
			 		{
			 			echo '<span style="color:red;font-size:15px">Sai Định Dạng Email!!!</span>';
			 		}
			 	}
 			?> -->
        	<?php 
        	...
        	<form action="" method="POST">
                	<input id="txtUser" type="text" name="email"  class="field" placeholder="Nhập email..." >
                    <input id="txtPass" type="password" name="password" class="field" placeholder="Nhập password..." >
            
    		 <button class="button button2" type="submit" name="login"  >Đăng nhập</button>
...
"></div></div> -->
    	...
    	<div class="register_account">
    		...
    		<form action="" method="POST">
						...
						<td>
							<div>
							<input type="text" name="username" placeholder="Nhập Name...">
							</div>
...
">
		   ...
		   <div class="search"><div><input type="submit" name="submit"  value="Tạo tài khoản" style="
    background: #ffffff;
"></div></div>
