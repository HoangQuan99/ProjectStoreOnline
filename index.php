    ...
    <div class="content">
    	<div class="content_top">
	      ...
	      <div class="section group">
	      	...
	      	?>
				<div class="grid_1_of_4 images_1_of_4" style="width: 300px">
					 <a href="details.php?proid=<?php echo $result['productId'] ?>"><img src="admin/uploads/<?php echo $result['image'] ?>"  width="200" height="200" alt="" /></a>
